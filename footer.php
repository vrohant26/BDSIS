	...
	<footer class="site-footer relative" id="site-footer">
		...
		<!-- Top Overlapping Submerged Cards Gallery Row -->
		<div class="footer-cards-container site-container relative">
			<div class="footer-cards-row flex justify-center gap-md">
		...
		<!-- Main Dark Purple Footer Body -->
		<div class="footer-main-body relative">
			<div class="site-container">
						...
						<ul class="footer-contact-list flex-column gap-xs">
							...
							<li class="contact-item flex gap-xs align-center">
								...
								<div class="flex-column">
									<span>+91 86575 46982</span>
									<span>+91 86577 97819</span>
									<span>+91 22 68066697</span>
								</div>
							</li>
							<li class="contact-item flex gap-xs align-center">
								<svg class="contact-icon flex-shrink-0" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<span>Monday to Saturday | 8.00 AM to 3.00 PM</span>
							</li>
							<li class="contact-item flex gap-xs align-center">
								...
								<a href="mailto:admissions@bdsiskharghar.org">admissions@bdsiskharghar.org</a>
							</li>
						</ul>
					</div>
				...
				<div class="footer-social-wrapper flex justify-start align-center flex-wrap gap-md">
